...
<svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17">
  <g id="add-check-16px" transform="translate(0.5 0.5)">
    ...
    <path id="Caminho_275" data-name="Caminho 275" d="M976.153,357.487h-.005" transform="translate(372.987 -968.148) rotate(90)" fill="none" stroke="#000" stroke-linecap="round" stroke-width="1"/>
    <path id="Caminho_276" data-name="Caminho 276" d="M976.153,357.487h-.005" transform="translate(365.487 -960.648) rotate(90)" fill="none" stroke="#000" stroke-linecap="round" stroke-width="1"/>
  </g>
</svg>
</template>
<script> 
 export default { name: "add-check" }
</script>